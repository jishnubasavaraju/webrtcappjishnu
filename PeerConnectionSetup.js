// Choose which peer connection suits the best for you

// choose which peer connection is best fro your browser
...
var RTCPeerConnection = function (options) {
    ...
    // return the most optimum RTCpeerconnection
    return {
...
// Ice Servers handler, the stun and turn servers would be added here
var IceServersHandler = (function() {
    function getIceServers(connection) {
        ...
        var iceServers = [{
            ...
            {
                'urls': [
                    'ws://13.234.38.96:8888/kurento', // coTURN 7788+8877
                ],
                'username': 'jishnubasavaraju',
                'credential': 'JISH@flexiele'
            }
        ];
